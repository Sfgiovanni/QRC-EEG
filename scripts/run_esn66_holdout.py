...
def main() -> None:
    ...
    for set_name in sets:
        ...
        for seed in cfg["channel"]["confirmatory_seeds"]:
            ...
            feats_train = construction_features("ESN", hp, seed=seed, segments=train_arr)
            feats_val = construction_features("ESN", hp, seed=seed, segments=val_arr)
    ...
    alpha_path = RESULTS_DIR / "selected_alphas_esn66.csv"
