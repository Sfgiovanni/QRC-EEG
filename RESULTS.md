...
10 seeds, `n=20` test segments per set):
...
genuine memory-capacity advantage. Capacity and EEG forecasting advantage
are **not** positively related in the fitted regression (capacity-gap slope
-0.0052, 95% CI [-0.0117, 0.0013] -- overlaps zero, if anything trends
negative). See `results/eeg/capacity_demand_regression_summary.csv`.
